...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         *
         *
         * @see \App\Providers\RequestServiceProvider::registerImmutableDate()
         * @param string $key
         * @return \Carbon\CarbonImmutable
         * @static
         */        public static function immutableDate($key)
        {
                        return \Illuminate\Http\Request::immutableDate($key);
        }
                    /**
         *
         *
         * @see \App\Providers\RequestServiceProvider::registerRoutePrimitiveMethods()
         * @param string $key
         * @return string
         * @static
         */        public static function routeString($key)
        {
                        return \Illuminate\Http\Request::routeString($key);
        }
            }
            /**
     *
